...
enum eNeptulonYells
{
    SAY_PHASE_1_1           = -1760091,
    SAY_PHASE_1_2           = -1760092,
    SAY_PHASE_2_1           = -1760093,
    SAY_PHASE_2_2           = -1760094,
    SAY_PHASE_3_1           = -1760095,
    SAY_PHASE_3_2           = -1760096,
    SAY_DEATH               = -1760097,
};
...
//                            DoScriptText(RAND(SAY_PHASE_2_1, SAY_PHASE_2_2), me);
//                        else if (phase == PHASE_OZUMAT)
//                            DoScriptText(RAND(SAY_PHASE_3_1, SAY_PHASE_3_2), me);
...
//            DoScriptText(SAY_DEATH, me);
        ...
        void StartEvent()
        {
            ...
            DoZoneInCombat();
//            DoScriptText(RAND(SAY_PHASE_1_1, SAY_PHASE_1_2), me);
