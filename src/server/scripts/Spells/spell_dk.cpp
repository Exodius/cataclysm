...
public:
    ...
    class spell_dk_shadow_infusion_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_dk_shadow_infusion_SpellScript::HandleEffect, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
        }
    };
...
public:
    ...
    class spell_dk_dark_transformation_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_dk_dark_transformation_SpellScript::HandleEffect, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
        }
    };
