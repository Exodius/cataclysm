...
class npc_tiki_target_troll : public CreatureScript
{
    ...
    {
        npc_tiki_target_trollAI(Creature* creature) : ScriptedAI(creature)
        {
...
class spell_bloodtalon_whistle : public SpellScriptLoader
{
    ...
    class spell_bloodtalon_whistle_SpellScript : public SpellScript
    {
        ...
        {
            unitList.remove_if (MovementCheck());
        }

        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_bloodtalon_whistle_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_DEST_AREA_ENTRY);
        }
    };
