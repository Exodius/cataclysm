...
{
   public:
       achievement_bg_bog_jugger_not() : AchievementCriteriaScript("achievement_bg_bog_jugger_not")
       {
       }

       bool OnCheck(Player* player, Unit* /*target*/)
       {
           if (player->GetBattlegroundTypeId() != BATTLEGROUND_BFG || !player->GetBattleground())
               return false;
...
{
   public:
       achievement_bg_bog_dont_get_cocky_kid() : AchievementCriteriaScript("achievement_bg_bog_dont_get_cocky_kid")
       {
       }
...
{
   public:
       achievement_bg_bog_full_coverage() : AchievementCriteriaScript("achievement_bg_bog_full_coverage")
       {
       }
