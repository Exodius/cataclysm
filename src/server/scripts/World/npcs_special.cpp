...
class npc_defensive_creature : public CreatureScript
{
public:
    npc_defensive_creature() : CreatureScript("npc_defensive_creature") {}

    struct npc_defensive_creatureAI : public ScriptedAI
    {
        npc_defensive_creatureAI(Creature* creature) : ScriptedAI(creature) {}
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return new npc_defensive_creatureAI(creature);
    }
};
