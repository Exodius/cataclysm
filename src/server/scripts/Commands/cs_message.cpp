...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand commandTable[] =
        {
            ...
            { "aname",          SEC_ADMINISTRATOR,  false,  &HandleAdminNameAnnounceCommand,    "", NULL },
    ...
    static bool HandleAdminNameAnnounceCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
        ...
        sWorld->SendWorldText(LANG_ANNOUNCE_COLOR_ADMIN, "Admin", name.c_str(), args);
        return true;
    }
