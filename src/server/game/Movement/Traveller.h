...
struct Traveller
{
    ...
    Traveller<T> & operator=(Traveller<T> const & obj)
    {
    ...
    float getX() const { return i_traveller.GetPositionX(); }
    float getY() const { return i_traveller.GetPositionY(); }
    float getZ() const { return i_traveller.GetPositionZ(); }
