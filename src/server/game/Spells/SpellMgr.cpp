    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
            ...
            case 92685: // Pestered
                ...
                break;
            case 33948:
                spellInfo->Effects[1].BasePoints = 300;
                break;
            case 82188: // Emerge (Corborus)
            case 77335: // Water Bubble (Water Warden)
            case 76674: // Chaos Blast (Setesh)
            case 74041: // Energy Flux (Isiset)
                spellInfo->MaxAffectedTargets = 1;
                break;
            case 75657: // Energize (Ammunae)
                spellInfo->StackAmount = 99;
                break;
            case 75702: // Noxious Spores (Ammunae)
            case 89889:
            ...
            case 83609: // Atrophic Poison
                ...
                break;
            case 73874: // Sun Strike (Rajh)
            case 82190: // Summon Beetle (Corborer)
                spellInfo->Effects[EFFECT_0].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_12_YARDS);
                break;
            case 73872: // Sun Strike (Rajh)
            case 89887:
                spellInfo->Effects[EFFECT_0].TargetA = SpellImplicitTargetInfo(TARGET_UNIT_CASTER);
                break;
            case 81629: // Submerge (Corborer)
            ...
            case 79332:
                ...
                spellInfo->Effects[EFFECT_2].TargetB = SpellImplicitTargetInfo(TARGET_UNIT_DEST_AREA_ENTRY);
                break;
            case 78835: // Elementium Spike Shield
            case 92429:
            ...
            case 95177:
                ...
                break;
            case 16213: // Purification (25% bonus - hotfix 16-2-2011 http://us.battle.net/wow/en/blog/2259389)
            ...
            case 92865:
                spellInfo->AttributesCu |= SPELL_ATTR0_CU_SHARE_DAMAGE;
                break;
            case 86631: // Engulfing Magic
                spellInfo->AttributesCu |= SPELL_ATTR0_CU_IGNORE_ARMOR;
                break;
            case 86380: // Dazzling Destruction
            case 92924:
                spellInfo->MaxAffectedTargets = 2;
                break;
            case 92923: // Dazzling Destruction
            case 92925:
                spellInfo->MaxAffectedTargets = 3;
                break;
            case 92134: // Ignition
            ...
            case 77782: // Sonic Flames
                ...
                break;
            case 75676: // Nether Beam (Corla)
                spellInfo->AttributesCu |= SPELL_ATTR0_CU_CONE_BACK;
                break;
            case 93539: // Bound Flames (Karsh)
...
void SpellMgr::LoadSpellInfoCorrections()
{
    ...
    for (uint32 i = 0; i < mSpellInfoMap.size(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
            ...
            case 80643: // Stalactite (Slabhide)
            case 80654:
            case 92653:
