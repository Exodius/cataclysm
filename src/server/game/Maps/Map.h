...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void GetRandomPointsInTriangle(std::list <Position> &posList, uint8 count, const Position &pos1, const Position &pos2, const Position &pos3);
    ...
    private:
        ...
        G3D::Vector3 PositionToVector3(const Position &pos) const;
