...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_INS_BUG_SUBMISSION, "INSERT INTO character_bug_submission (content, playerId, position_x, position_y, position_z, orientation, mapId) VALUES (?, ?, ?, ?, ?, ?, ?)", CONNECTION_BOTH);
}
